...
if ("WaterThermometer" not in (IoTDevice.IoTDevice.deviceTypes[0]).keys()):
   IoTDevice.IoTDevice.deviceTypes[0]["WaterThermometer"] = [
      {
...
class WaterThermometer (IoTDevice.IoTDevice):
   def __init__ (self, deviceName=None):
      super().__init__(deviceType="WaterThermometer", deviceName=deviceName)
