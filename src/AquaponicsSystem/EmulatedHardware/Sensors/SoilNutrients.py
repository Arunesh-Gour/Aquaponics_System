...
if ("SoilNutrients" not in (IoTDevice.IoTDevice.deviceTypes[0]).keys()):
   IoTDevice.IoTDevice.deviceTypes[0]["SoilNutrients"] = [
      {
...
class SoilNutrients (IoTDevice.IoTDevice):
   def __init__ (self, deviceName=None):
      super().__init__(deviceType="SoilNutrients", deviceName=deviceName)
