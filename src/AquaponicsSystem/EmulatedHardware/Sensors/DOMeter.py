...
if ("DOMeter" not in (IoTDevice.IoTDevice.deviceTypes[0]).keys()):
   IoTDevice.IoTDevice.deviceTypes[0]["DOMeter"] = [
      {
...
class DOMeter (IoTDevice.IoTDevice):
   def __init__ (self, deviceName=None):
      super().__init__(deviceType="DOMeter", deviceName=deviceName)
