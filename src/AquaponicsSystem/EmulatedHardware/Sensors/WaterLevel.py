...
if ("WaterLevel" not in (IoTDevice.IoTDevice.deviceTypes[0]).keys()):
   IoTDevice.IoTDevice.deviceTypes[0]["WaterLevel"] = [
      {
...
class WaterLevel (IoTDevice.IoTDevice):
   def __init__ (self, deviceName=None):
      super().__init__(deviceType="WaterLevel", deviceName=deviceName)
