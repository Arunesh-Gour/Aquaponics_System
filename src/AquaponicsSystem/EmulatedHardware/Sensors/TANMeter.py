...
if ("TANMeter" not in (IoTDevice.IoTDevice.deviceTypes[0]).keys()):
   IoTDevice.IoTDevice.deviceTypes[0]["TANMeter"] = [
      {
...
class TANMeter (IoTDevice.IoTDevice):
   def __init__ (self, deviceName=None):
      super().__init__(deviceType="TANMeter", deviceName=deviceName)
